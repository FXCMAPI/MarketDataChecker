...
class PdasGetOrdersRequestMessage extends APdasRequestMessage {
    build(tradingSession, acctId, requestNumberGenerator, transactTime) {
        ...
        pdasMessage.addChild(factory.createStringField(PdasMessageFieldTag.FXCM_COMMAND_ID, PdasRequestCommand.GET_ORDERS));
        pdasMessage.addChild(factory.createStringField(PdasConstants.SID, tradingSession.getSessionId()));
        result = PdasTransportMessage.create(TransportMessageType.GetOrders, this.createRequestUrl(terminalUrl), pdasMessageSerializer.serialize(pdasMessage));
        return result;
    }
}
module.exports = PdasGetOrdersRequestMessage
