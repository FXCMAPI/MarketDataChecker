...
class PdasRemoveOrderRequestMessage extends APdasRequestMessage {
    build(tradingSession, acctId, orderId, requestNumberGenerator, transactTime) {
        ...
        group.addChild(factory.createStringField(PdasMessageFieldTag.FXCM_PARAM_VALUE, orderId));
        ...
        pdasMessage.addChild(factory.createStringField(PdasMessageFieldTag.FXCM_COMMAND_ID, PdasRequestCommand.REMOVE_ORDER));
        pdasMessage.addChild(factory.createStringField(PdasConstants.SID, tradingSession.getSessionId()));
        result = PdasTransportMessage.create(TransportMessageType.RemoveOrder, this.createRequestUrl(terminalUrl), pdasMessageSerializer.serialize(pdasMessage));
        return result;
    }
}
module.exports = PdasRemoveOrderRequestMessage
